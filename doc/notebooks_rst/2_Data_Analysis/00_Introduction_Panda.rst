.. Note::
  ...
  This notebook can be downloaded here: :download:`00_Introduction_Panda.ipynb <../../notebooks/2_Data_Analysis/00_Introduction_Panda.ipynb>` 
...
This notebook gives some key functions to work with data base using the
panda module (https://pandas.pydata.org/)
...
Let’s compute teh mean of both notes
------------------------------------
